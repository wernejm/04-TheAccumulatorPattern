...
def run_test_factorial():
    ...
    print('Test 5 expected (from hand-solved work):', answer_from_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 4
    answer = count_cosines_from(18, 29, 0.63)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(200, 205, -0.37)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.00598  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1001, 1006)
