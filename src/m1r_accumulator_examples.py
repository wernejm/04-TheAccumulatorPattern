...
#                  return count
#
#           Errors: for loop argument should be r + 1 - s, to be inclusive
#                   count = 0 should be outside the for loop
#                   argument of math.cos() should be k
#                   in fourth line, count = count + 1 to continually count
#                   return count should be outside of for loop to return the final count
#
#
...
#                  circle.attach_to(window)
#
#         ---- incorrect code:     x = starting_point.x
#              for k in range(n):
#                  center = rg.Point(x + (k * diameter), y)
#                  circle = rg.Circle(point, radius)
#                  circle.attach_to(window)
